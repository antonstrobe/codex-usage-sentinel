...
$sourceFiles = @('Version.cs','Core.cs','Alarms.cs','AlarmForms.cs','Monitor.cs','RelayClient.cs','RelaySetupForm.cs','App.cs','Tests.cs') | ForEach-Object { Join-Path $PSScriptRoot ('src\' + $_) }
