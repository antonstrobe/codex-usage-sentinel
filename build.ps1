...
$sourceFiles = @('Version.cs','Core.cs','Alarms.cs','AlarmForms.cs','Monitor.cs','StatusMessages.cs','RelayClient.cs','RelaySetupForm.cs','GroupSetupForm.cs','App.cs') | ForEach-Object { Join-Path $PSScriptRoot ('src\' + $_) }
